/* ============================================================
   ...
   "inicio", "iot", "pcb-fabrication", "schematic", "fixturing", "product-design", "proyectos", "contacto"
   ============================================================ */
(function () {
  ...
  var items = [
    ...
    { id: 'diseno', label: 'Diseño y Prototipo', children: [
        { id: 'iot', href: 'iot-capabilities.html', label: 'Capacidades IoT/IIoT' },
        { id: 'schematic', href: 'schematic-design.html', label: 'Diseño de Esquemáticos' },
        { id: 'pcb-fabrication', href: 'pcb-fabrication.html', label: 'Fabricación de PCB' },
        { id: 'fixturing', href: 'fixturing-design.html', label: 'Diseño de Fixtures' },
        { id: 'product-design', href: 'product-design.html', label: 'Diseño de Producto Completo' }
      ]
    },
